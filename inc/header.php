<?php 
    ...
    $contact_q = "SELECT * FROM `contact_details` WHERE `id_no`=?";
    $values = [1];
...
<nav id="nav-bar" class="navbar navbar-expand-lg bg-body-tertiary px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">Hotel Margarette</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle me-2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">More</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item me-2" href="facilities.php">Facilities</a></li>
                        <li><a class="dropdown-item me-2" href="about.php">About</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item me-2" href="contact.php">Contact us</a></li>
                    </ul>
                </li>
            </ul>
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                            Note: Your details must match with your ID (Student ID, Goverment Issued ID, etc.)
